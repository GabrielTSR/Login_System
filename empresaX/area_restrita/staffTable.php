...
$funcionarios = lerArquivo("../data/empresaX.json");
?>
...
<body>
    ...
    <header class="toolbar">
        <h2>
            Hello <?=ucfirst(strtolower($_SESSION['usuario']))?>!
        </h2>
        <div class="bar"></div>
        <div id="login-made-on-container">
            <h2>
                <span id="login-made-on-label">Login made on:</span>
                <span id="login-made-on-time"><?=$_SESSION['data_hora']?></span>
            </h2>
        </div>
